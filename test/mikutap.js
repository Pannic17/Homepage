...
var MainManager = function () {
    ...
    function n (n) {
        (U = !U) ? ($ ("#bt_feedback a").text ("FEEDBACK: ON"), aidn.util.setCookie ("fb", "on", 2592e3)) : ($ ("#bt_feedback a").text ("FEEDBACK: OFF"), aidn.util.setCookie ("fb", "off", 2592e3)), n && n.preventDefault ()
    }

    function o (n) {
        (T = !T) ? ($ ("#bt_backtrack a").text ("BACKTRACK: ON"), aidn.util.setCookie ("bt", "on", 2592e3)) : ($ ("#bt_backtrack a").text ("BACKTRACK: OFF"), aidn.util.setCookie ("bt", "off", 2592e3)), n && n.preventDefault ()
    }

    function r () {
        C.update (), 1 == x && --D < 0 && v (), function () {
            if (!p) return;
            if (1 != x) return;
    ...
    var G, A, y = aidn.util.checkJapanese (), E = aidn.util.checkMobile (), w = "https://aidn.jp/mikutap/",
        M = "Mikutap";
    M += y ? ",蛻晞浹繝溘け10蜻ｨ蟷ｴ" : ",Miku10th", $ ("#bt_tw").click (function (n) {
    ...
    var m, I, z, b = 0, x = 0, C = new function () {
        ...
        this.play = function (n, a) {
            var e = 1e3 * (aidn.___waContext.currentTime + h[n] - m), t = Math.floor (e / f);
        ...
        var s = function (n, a) {
            ...
            var e = 0, t = 0, i = 0, o = 0, r = new PIXI.Graphics;
            ...
            this.resize = function () {
                ...
                for (var n = 0; n < 3; n += 2) TweenLite.delayedCall (.07 * n, a), TweenLite.delayedCall (.07 * (n + 1), e)
            }, this.setColor = function (n, a) {
                i = n, a = 0 <= a ? a : 0, r.setChildIndex (o, a), t.resize ()
            };
            var t = this, i = 16777215, o = new PIXI.Graphics, r = n;
            r.addChild (o)
        }, d = function (n, a) {
            function e () {
                var n, a, e, t = 1.3 * d;
                if (f.clear (), f.beginFill (0), f.moveTo (0, 0), 0 == o) for (var i = 0; i < c.rotation; i += 30) n = (s * i + l) * Math.PI / 180, a = Math.cos (n) * t, e = Math.sin (n) * t, f.lineTo (a, e); else for (i = 360; c.rotation < i; i -= 30) n = (s * i + l) * Math.PI / 180, a = Math.cos (n) * t, e = Math.sin (n) * t, f.lineTo (a, e);
                n = (s * c.rotation + l) * Math.PI / 180, a = Math.cos (n) * t, e = Math.sin (n) * t, f.lineTo (a, e), f.lineTo (0, 0), f.endFill ()
            }

            function t () {
                o = 1, TweenLite.fromTo (c, .9, {rotation: 0}, {
                    rotation: 360,
                    ease: Power1.easeOut,
                    onUpdate: e,
                    onComplete: i
            ...
            this.play = function (n, a) {
                o = 0, d = n, r = a, l = 360 * Math.random (), s = 1, Math.random () < .5 && (s = -1), f.clear (), f.beginFill (0), f.moveTo (0, 0), f.lineTo (1, 1), f.endFill (), TweenLite.fromTo (c, .6, {rotation: 0}, {
                    rotation: 360,
                    ease: Power1.easeOut,
                    onUpdate: e,
                    onComplete: t
            ...
            var o, r, l, s, d, h = n, c = {rotation: 0}, f = new PIXI.Graphics;
            h.addChild (f), a.mask = f
        }, r = function (n) {
            function h () {
                w.clear (), 0 == f ? w.lineStyle (v, u) : w.beginFill (u);
                for (var n = 0; n < p; n++) {
                    var a = M["p" + n].x, e = M["p" + n].y;
            ...
            this.play = function (n, a) {
                f = n, e = a, function () {
                    ...
                    for (var t = 360 / p, i = 0; i < p; i++) {
                        var o = i * t * Math.PI / 180, r = a * Math.cos (o), l = a * Math.sin (o),
                            s = r + a * (Math.random () - .5) * n, d = l + a * (Math.random () - .5) * n;
                        M["p" + i] = {x: r, y: l}, TweenLite.to (M["p" + i], .6, {x: s, y: d})
                    }
                    M.progress = 0, TweenLite.to (M, .8, {progress: 1, onUpdate: h, onComplete: c})
                } ()
            };
            ...
            var f = function (n) {
                ...
                function o () {
                    0 == u ? (u = 1, s = {x: r.x, y: r.y}, TweenLite.to (s, f, {
                        x: l.x,
                        y: l.y,
                        ease: Power1.easeOut,
                        onUpdate: i,
                ...
                this.play = function (n, a, e, t) {
                    return v.visible = !0, u = 0, r = n, l = a, d = e, h = t, c = .2 * Math.random () + .2, f = .2 * Math.random () + .2, s = {
                        x: r.x,
                        y: r.y
                    }, TweenLite.to (s, c, {x: l.x, y: l.y, ease: Power1.easeOut, onUpdate: i, onComplete: o}), c + f
                };
            ...
            this.play = function (n) {
                e = n, function () {
                    ...
                    for (var n, a = Math.floor (7 * Math.random () + 2), e = .8 * Math.min (G, A), t = (v.size = e) / a * (.4 * Math.random () + .7), i = e / a * (.4 * Math.random () + .1), o = L (), r = 0, l = 0; l <= a; l++) {
                        var s = (l - .5 * a) * t, d = {x: -e / 2, y: s}, h = {x: e / 2, y: s},
        ...
        function i (n) {
            ...
            if (c (e), n.originalEvent && n.originalEvent.touches) for (var t = n.originalEvent.touches.length, i = 1; i < t; i++) {
        ...
        this.resize = function () {
            if (w) {
                var n = 0, a = v, e = p;
                A < G && (a = p, e = v);
                for (var t = G / a, i = A / e, o = 0; o < e; o++) for (var r = 0; r < a; r++) {
                    var l;
        ...
        var f, u = -1, v = 4, p = 8, y = !1, w = !1, M = [], m = [function (n, a) {
            var s = function (n) {
                ...
                this.play = function (n, a, e) {
                    s.visible = !0, s.clear ();
                    var t = G * Math.random (), i = A * Math.random (),
                    ...
                    return TweenLite.to (s, r, {
                        ...
                        ease: Power3.easeOut,
                        onComplete: l
                    }), TweenLite.to (s.scale, r, {x: 1, y: 1, ease: Back.easeOut.config (1.7)}), r
                };
                var a = n, s = new PIXI.Graphics;
                a.addChild (s)
            };
            ...
            var h = function (n) {
                function r () {
                    h.beginFill (l), h.drawCircle (0, 0, s), h.scale.x = 0, h.scale.y = 0, TweenLite.to (h.scale, .7, {
                        x: 1,
                        y: 1,
                ...
                function a () {
                    TweenLite.to (h.scale, .4, {x: 0, y: 0, ease: Power2.easeOut, onComplete: e, delay: .1})
                }
                ...
                this.play = function (n, a, e, t, i, o) {
                    h.visible = !0, h.clear (), h.x = t, h.y = i, l = a, s = e, d = o, TweenLite.delayedCall (n, r)
                };
            ...
            this.play = function () {
                !function () {
                    ...
                    var n = L (), a = Math.min (G, A) * (.28 * Math.random () + .2),
                    ...
                    var s = .8 * Math.random () + .4, d = .8 * Math.random () + .4;
                    TweenLite.fromTo (u.scale, .9, {x: s, y: s}, {x: d, y: d, ease: Bounce.easeOut}), v.play (a, h)
                } ()
            };
            var e = this, c = n;
            this.id = a;
            var f = new PIXI.Container, u = new PIXI.Graphics;
            c.addChild (f), f.addChild (u);
            var v = new d (f, u)
        }, function (n, a) {
            var i = function (n) {
                function e () {
                    var n = Math.min (G, A), a = n * (.08 * Math.random () + .05);
                    l.lineStyle (4 * Math.random () + 4, L ()), l.drawRect (-a / 2, -a / 2, a, a), l.x = o + n / 2 * (Math.random () - .5), l.y = r + n / 2 * (Math.random () - .5), l.scale.x = 0, l.scale.y = 0, l.rotation = Math.random () * Math.PI, TweenLite.to (l, .5, {
                        x: o,
                        y: r,
                        rotation: 0,
                        ease: Back.easeOut.config (1.7),
                        onComplete: t
                    }), TweenLite.to (l.scale, .5, {x: 1, y: 1, ease: Back.easeOut.config (1.7)})
                }

                function t () {
                    var n = Math.min (G, A), a = o + n / 2 * (Math.random () - .5),
                    ...
                    TweenLite.to (l, .5, {
                        ...
                        onComplete: i,
                        delay: .2
                    }), TweenLite.to (l.scale, .5, {x: 0, y: 0, ease: Back.easeIn.config (1.7), delay: .2})
                }
                ...
                this.play = function (n, a) {
                    l.visible = !0, l.clear (), o = G * Math.random (), r = A * Math.random (), TweenLite.delayedCall (n, e)
                };
            ...
            var i = function (n) {
                function e () {
                    ...
                    l.beginFill (L ()), l.drawCircle (0, 0, n), l.x = i, l.y = o, l.scale.x = 0, l.scale.y = 0, TweenLite.to (l.scale, .5, {
                        x: 1,
                        y: 1,
                        ease: Elastic.easeOut.config (1, .3),
                        onComplete: a
                ...
                function a () {
                    TweenLite.to (l.scale, .5, {x: 0, y: 0, ease: Back.easeIn.config (1.7), onComplete: t, delay: .2})
                }
                ...
                this.play = function (n, a) {
                    l.visible = !0, l.clear (), i = G * Math.random (), o = A * Math.random (), TweenLite.delayedCall (n, e)
                };
            ...
            this.play = function () {
                !function () {
                    ...
                    var a = 45 * Math.PI / 180 * Math.floor (2 * Math.random ()),
                        e = a + 45 * Math.PI / 180 * Math.floor (4 * Math.random () - 2), t = .3 * Math.random () + 1,
                        i = .3 * -Math.random () + 1;
                    TweenLite.fromTo (d.container, .6, {rotation: a}, {
                        rotation: e,
                        ease: Power2.easeOut
                    }), TweenLite.fromTo (d.container.scale, .6, {x: t, y: t}, {
                        x: i,
                        y: i,
                        ease: Back.easeOut.config (1.7)
                    }), TweenLite.fromTo (s.scale, .6, {x: t, y: t}, {x: i, y: i, ease: Back.easeOut.config (1.7)})
                } ()
            };
            var e = this, r = n;
            this.id = a;
            ...
            this.play = function () {
                !function () {
                    ...
                    for (var n = .6 * Math.min (G, A), a = Math.floor (5 * Math.random ()) + 3, e = 360 / a, t = .5 * Math.max (G, A) / n * (1.6 + .6 / a), i = 0; i <= a; i++) {
                        var o = i * e * Math.PI / 180, r = n * Math.cos (o), l = n * Math.sin (o);
                        0 == i ? c.moveTo (r, l) : c.lineTo (r, l)
                    }
                    var s = .3 * Math.random () + .6;
                    TweenLite.fromTo (c.scale, s, {x: 0, y: 0}, {
                        x: t,
                        y: t,
                        onComplete: d,
                        ease: Power2.easeOut
                    }), TweenLite.fromTo (c, s, {rotation: Math.random () * Math.PI}, {
                        rotation: Math.random () * Math.PI,
                        ease: Power1.easeOut
                    })
                } ()
            ...
            this.play = function () {
                !function () {
                    ...
                    var n = L (), a = Math.min (G, A) * (.25 * Math.random () + .1);
            ...
            var u = function (n) {
                ...
                this.init = function (n, a, e, t) {
                    ...
                    i = a, l.clear (), l.visibloe = !0, l.beginFill (r), l.drawRect (.5 * -o, .5 * -o, o, o), TweenLite.fromTo (l.scale, .3, {
                        x: 0,
                        y: 0
                    }, {
                        x: 1,
                        ...
                        onComplete: t,
                        delay: n
                    }), TweenLite.fromTo (l, .7, {rotation: Math.random () * Math.PI * 2}, {
                        rotation: 0,
                        ease: Elastic.easeOut.config (1, .3),
                        delay: n
                    });
                    var e = Math.random () * Math.PI;
                    TweenLite.fromTo (y, 1, {rotation: 0}, {rotation: e, ease: Bounce.easeOut, delay: n})
                };
            ...
            this.play = function () {
                !function () {
                    ...
                    var n = Math.floor (8 * Math.random () + 6), a = Math.min (G, A) * (.25 * Math.random () + .25),
                        e = 360 / n, t = a * (.15 * Math.random () + .05), i = L (),
                        o = Math.PI / 2 * Math.floor (4 * Math.random ()), r = 1;
                    Math.random () < .5 && (r = -1);
                    for (var l = 0; l < n; l++) {
            ...
            var e = this, p = n;
            this.id = a;
            var y = new PIXI.Container, w = [];
            p.addChild (y)
        }, function (n, a) {
            var u = function (n) {
                function e () {
                    var n = .5 * G, a = l.x + Math.random () * n - n / 2, e = l.y + Math.random () * n - n / 2;
                    TweenLite.to (l.scale, .3, {
                        ...
                        onComplete: t,
                        delay: .5
                    }), TweenLite.to (l, .3, {x: a, y: e, ease: Power2.easeOut, delay: .5})
                }
                ...
                this.init = function (n, a, e, t) {
                    ...
                    i = a, l.clear (), l.visibloe = !0, l.beginFill (r), l.drawCircle (0, 0, .5 * o), TweenLite.fromTo (l.scale, .3, {
                        x: 0,
                        y: 0
            ...
            this.play = function () {
                !function () {
                    p.setChildIndex (y, p.children.length - 1), y.visible = !0, y.x = G / 2, y.y = A / 2;
                    var n = Math.floor (8 * Math.random () + 6), a = Math.min (G, A) * (.2 * Math.random () + .25),
                        e = 360 / n, t = a * (.2 * Math.random () + .05), i = L (),
                        o = Math.PI / 2 * Math.floor (4 * Math.random ()), r = 1;
                    Math.random () < .5 && (r = -1);
                    for (var l = 0; l < n; l++) {
                        var s, d = (r * e * l + o) * Math.PI / 180, h = a * Math.cos (d), c = a * Math.sin (d);
            ...
            this.play = function () {
                !function () {
                    ...
                    var n, a = Math.min (G, A) * (.7 + .2 * Math.random ()), e = a / 10 * (.5 + .8 * Math.random ()),
                        t = L ();
                    l.clear (), l.beginFill (t), l.drawRect (0, -e / 2, a, e), s.clear (), s.beginFill (t), s.drawRect (-e / 2, 0, e, a), l.y = 0, l.x = -a / 2, s.x = 0, s.y = -a / 2, r.rotation = 45 * Math.PI / 180, l.scale.x = 0, s.scale.y = 0, n = Math.random () < .5 ? -135 * Math.PI / 180 : 215 * Math.PI / 180, (new TimelineLite).to (l.scale, .4, {
                        x: 1,
                        ease: Power2.easeOut
                    }).to (s.scale, .4, {y: 1, ease: Power2.easeOut}, .1).to (r, .6, {
                        rotation: n,
                        ease: Back.easeOut.config (1.7)
                    }, 0).to (l.scale, .3, {x: 0, ease: Power2.easeOut}).to (s.scale, .3, {
                        y: 0,
                        ease: Power2.easeOut,
                        onComplete: i
                    }, .6)
            ...
            var e = this, o = n;
            this.id = a;
            var r = new PIXI.Container, l = new PIXI.Graphics, s = new PIXI.Graphics;
            ...
            function o () {
                if (r < ++c) switch (l) {
                    ...
                    case 1:
                        l = 2
                } else TweenLite.to (f, .1, {x: h[c].x, y: h[c].y, onComplete: o, onUpdate: e, ease: Power1.easeOut})
            }
            ...
            var t = n;
            this.id = a;
            var r, l, s, d, h = [], c = 0, f = {x: 0, y: 0}, u = new PIXI.Graphics;
            t.addChild (u)
        }, t], I = [function (n, a) {
            function d () {
            ...
            this.play = function () {
                !function () {
                    ...
                    var a = Math.random () < .5, e = Math.floor (4 * Math.random ()) + 1;
                    u.pos = {};
                    var t = 0;
                    a ? (t = A / e, u.pos.b0 = {x: 0, y: 0}, u.pos.b1 = {x: 0, y: A}) : (t = G / e, u.pos.b0 = {
                        x: 0,
                        y: 0
                    }, u.pos.b1 = {
                        x: G,
                    ...
                    for (var i = f = 0; i <= e; i++) {
                        ...
                        f = 2, l = a ? {x: G} : {y: A}, TweenLite.to (u.pos["p" + i], s, l)
                    }
                    u.progress = 0, TweenLite.to (u, f, {
                        progress: 1,
        ...
        var T,
            P = [13430510, 8965324, 9099756, 961181, 1089457, 34969, 13934238, 16110792, 15488645, 16531063, 5853015, 3222317],
    ...
    function i () {
        if (a++, h.now = a, s && s (a, o), o <= a) l && l (); else {
